...
const fallback = {
    ...
    "session.unknownCommand": "Unknown command: {command}. Send /help for the list.",
    "session.queued": "Queued {command}. I'll run it when the current turn finishes.",
    "session.error": "Session command failed: {error}",
    "session.help.title": "Session commands:",
    "session.help.item": "  {command} - {description}",
    "session.list.title": "Sessions (most recent first):",
    "session.list.empty": "No sessions found.",
    "session.list.group": "📁 {label} ({cwd})",
    "session.list.item": "  {n}. {title} - {age}, {count} msg{active}",
    "session.list.active": " [active]",
    "session.list.untitled": "untitled",
    "session.list.unknownProject": "unknown project",
    "session.list.truncated": "… showing {shown} of {total}; older sessions omitted. Run /sessions again after switching to see more.",
    "session.age.now": "just now",
    "session.age.minutes": "{count}m ago",
    "session.age.hours": "{count}h ago",
    "session.age.days": "{count}d ago",
    "session.resume.unknown": "Unknown session '{target}'. Run /sessions for the list.",
    "session.resume.switched": "Switched to {title}.",
    "session.resume.recap": "Resumed {title} ({project}).",
    "session.resume.lastUser": "👤 {text}",
    "session.resume.lastAssistant": "🤖 {text}",
    "session.new.pathRequired": "A project path is required. Usage: /new <path> [title] — use . for the current project.",
    "session.new.pathNotFound": "Project path not found or not a directory: {path}",
    "session.new.createdProject": "New session started in {project}.",
    "session.new.createdProjectTitle": "New session started in {project} as '{title}'.",
    "session.title.current": "Current session title: {name}",
    "session.title.none": "This session has no title yet. Session id: {id}",
    "session.title.renamed": "Renamed the active session to '{name}'.",
    "session.branch.nothing": "Nothing to branch from.",
    "session.branch.created": "Branched into a new session.",
    "session.undo.nothing": "Nothing to undo.",
    "session.undo.done": "Undid the last exchange.",
    "session.compact.done": "Context compacted.",
    "session.abort.done": "Aborted.",
